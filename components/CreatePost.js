...
const CreatePost = () => {
    ...
    return <div className="bg-white rounded-md shadow-md text-gray-500 p-2">
    ...
    <div className="flex justify-evenly py-2">
        <div
            ...
            />
            <p className="font-semibold text-gray-600">Photo or Video</p>
            <input             
    ...
    <div className="flex justify-evenly p-2">
        <button className="rounded bg-purple-400 hover:bg-purple-500 text-white px-6 py-1 w-full" onClick={handleSubmit}>Post</button>
    </div>
  </div>;
};
